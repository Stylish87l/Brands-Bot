...
import type { VideoCreative } from '../types';
...
const VideoModal: React.FC<VideoModalProps> = ({ creative, onClose }) => {
    ...
    >
      ...
      >
        <div className="flex-shrink-0 flex items-center justify-between pb-3 border-b border-gray-200 dark:border-gray-700">
          <div>
              <h2 id="video-modal-title" className="text-xl font-bold text-gray-900 dark:text-white">{creative.platformName}</h2>
        ...
        <div className="flex-shrink-0 pt-3 border-t border-gray-200 dark:border-gray-700">
            <a 
              ...
              download={`${creative.platformName.replace(/ /g, '_')}_video.mp4`}
